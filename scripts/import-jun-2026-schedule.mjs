/**
 * June 2026 schedule import from spreadsheet screenshot.
 * Sheet PL → AL; AB → ABS; blanks → SHIFT + weekly OFF.
 *
 *   node scripts/import-jun-2026-schedule.mjs
 *   node scripts/import-jun-2026-schedule.mjs --dry-run
 */
 ...
 * sheet shows continuous rows (OCR often misses comment-triangle cells).
 */
const SHEET_MARKS = {
  // Full-month ABS (OUT / ON Board with AB:30)
  ORL0001: ALL_ABS,
  ORL0002: ALL_ABS,
  ORL0003: ALL_ABS,
  ORL0004: ALL_ABS,
  ...
  // Partial / mixed
  ORL0018: range(1, 16, "UPL"),
  // Summary AB14: day 6 + 18–30
  ORL0024: merge({ 6: "ABS" }, range(18, 30, "ABS")),
  // Summary PH5: 7 + 18–21
  ORL0029: merge({ 7: "PH-REPL" }, range(18, 21, "PH-REPL")),
  ORL0032: { 5: "PH-REPL", 28: "PH-REPL" },
  ORL0039: { 10: "PH-REPL", 29: "PH-REPL", 30: "PH-REPL" },
  // Summary PH9 PL7
  ORL0040: merge(range(15, 23, "PH-REPL"), range(24, 30, "AL")),
  // Summary UPL15
  ORL0046: merge(
    range(1, 7, "UPL"),
    range(16, 18, "UPL"),
  ...
  ORL0054: { 15: "PH-REPL", 30: "PH-REPL" },

  // Single / dual PH
  ORL0005: { 21: "PH-REPL" },
  ORL0013: { 25: "PH-REPL" },
  ORL0014: { 4: "PH-REPL", 27: "PH-REPL" },
  ORL0021: { 21: "PH-REPL" },
  ORL0026: { 26: "PH-REPL" },
  ORL0041: { 15: "PH-REPL" },
  ORL0053: { 5: "PH-REPL" },
...
async function main() {
  ...
  console.log(`\nDone. June 2026 schedule days for Orilla: ${count}`);
}

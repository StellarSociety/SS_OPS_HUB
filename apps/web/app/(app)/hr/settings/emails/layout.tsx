  ...
  return (
    <div className="space-y-4">
      <HrSettingsSectionHeader
        title="Emails"
        description="Default header and footer, acknowledgement page and reminder emails, PAY (payroll package, Final Approval requests, and payslips), and boarding delivery for this venue."
      />

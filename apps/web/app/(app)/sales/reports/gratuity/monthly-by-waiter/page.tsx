...
import { GratuityByWaiterReportPreview } from "@/components/sales/gratuity-by-waiter-report-preview";
import {
...
export default async function MonthlyGratuityByWaiterReportPage() {
  ...
  try {
    ...
    console.error("[sales/reports/gratuity/monthly-by-waiter]", error);

...
export function MobileTabBar({
  ...
  const bar = (
    ...
    >
      <div className="pointer-events-none relative mx-auto flex w-full max-w-md justify-center bg-transparent px-4 pb-[max(10px,calc(var(--mobile-safe-bottom,0px)-22px))] pt-1">
        <nav
          aria-label="App"

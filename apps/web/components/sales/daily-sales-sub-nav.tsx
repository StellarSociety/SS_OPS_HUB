...
const tabs = [
  { href: "/sales/daily", label: "Insights", exact: true as const },
  { href: "/sales/daily/entry", label: "Entry Form", exact: false as const },
  { href: "/sales/daily/data", label: "Data Table", exact: false as const },
] as const;

export function DailySalesSubNav() {
  const pathname = usePathname();

  return (
    <nav
      aria-label="Daily Sales sections"

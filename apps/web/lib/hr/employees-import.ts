...
export const EMPLOYEE_IMPORT_COLUMNS: EmployeeImportColumn[] = [
  ...
  { key: "passport_expiry", label: "Passport Expiry Date", type: "date", value: (s) => s.passport_expiry },
  { key: "eid_no", label: "EID no.", type: "text", value: (s) => s.eid_no },
  { key: "eid_issue_date", label: "EID issue date", type: "date", value: (s) => s.eid_issue_date },
